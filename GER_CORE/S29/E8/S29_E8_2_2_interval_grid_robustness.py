...
Experiment:
    S29.E8.2.2 - interval grid robustness

Objective
---------
Verify whether the geometric properties remain invariant over arbitrary
observation intervals.

The experiment evaluates a two-dimensional grid of trajectory intervals,
varying both the initial and final observation indices.
-----
...
GER_RESULTS/
    S29/
        S29_E8_2_2_cumulative-window_robustness_scan/
...
def export_report(summary):
    ...
    lines.append("INTERVAL GRID ROBUSTNESS")
    lines.append("=" * 80)
    lines.append("")
...
def print_summary(summary):
    ...
    print("=" * 80)
    print("S29 E8.2.2")
    print("interval-grid robustness scan...")
    print("=" * 80)
...
def main():
    ...
    print("Running interval-grid robustness scan...")
